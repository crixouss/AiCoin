  ...
  return (
      <div className="min-h-screen text-gray-900 flex justify-center">
          <div className="max-w-screen-xl m-0 sm:m-10 bg-white shadow sm:rounded-lg flex justify-center flex-1">
              <div
                  className="flex-1 bg-gradient-to-r from-main-dark to-orange-800 text-center hidden lg:flex rounded-l">
                  <div
                  ...
                  <div className="mt-12 flex flex-col items-center">
                      ...
                      <div className="w-full flex-1 mt-8">
                          <div className="flex flex-col items-center">
                              ...
                              <button
                                  className="w-full max-w-xs font-bold shadow-sm rounded-lg py-3 bg-orange-100 text-gray-800 flex items-center justify-center transition-all duration-300 ease-in-out focus:outline-none hover:shadow focus:shadow-sm focus:shadow-outline mt-5">
                          ...
                          <div className="mx-auto max-w-xs">
                              ...
                              <p className="mt-6 text-xs main-dark text-center">
                                  I agree CoinGenius
                                  <Link to="/terms" className="text-main-dark border-gray-500 mx-1">
                                      Terms of Service
                                  </Link>
                                  <span className="">and its</span>
                                  <Link to="/cookies" className="text-main-dark border-gray-500 mx-1">
                                      Privacy Policy
                                  </Link>
                              </p>
                          </div>
